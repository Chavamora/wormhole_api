...
var objectPublicacionList = []
var globalPublicacionDocList = []
...
function getAllPublicaciones (req, res)  {
    ...
    async (err, user) => {
        ...
        globalPublicacionDocList = publicacionDocList
        objectPublicacionList = globalPublicacionDocList.map(async (publicacionDoc) =>{
            var publicacion = publicacionDoc.toObject()
